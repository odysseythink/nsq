...
import (
	...
	"mlib.com/nsq/internal/http_api"
...
func main() {
	...
	flag.Var(&nsq.ConfigFlag{cfg}, "consumer-opt", "option to passthrough to nsq.Consumer (may be given multiple times, http://godoc.org/mlib.com/go-nsq#Config)")
	flag.Parse()
