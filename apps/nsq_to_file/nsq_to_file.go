...
func flagSet() *flag.FlagSet {
	...
	fs.Var(&consumerOpts, "consumer-opt", "option to passthrough to nsq.Consumer (may be given multiple times, http://godoc.org/mlib.com/go-nsq#Config)")
...
func main() {
	...
	opts := NewOptions()
	mskeleton.OptionResolve(opts, fs, nil)
